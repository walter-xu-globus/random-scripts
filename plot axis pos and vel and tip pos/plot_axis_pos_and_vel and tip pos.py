...
def plot(mine, original):
    ...
    for axis_num in range(5):
        ax[axis_num, 0].plot(mine.axis_time, mine.axis_pos[axis_num, :], color="r", label="Mine")
    ...
    for axis_num in range(5):
        ax[axis_num, 1].plot(mine.axis_time, mine.axis_vel[axis_num, :], color="r", label="Mine")
    ...
    fig.text(0.7, 0.04,'Velocity (mm/s)', va='center',  fontsize=12)
    fig.text(0.3, 0.04, 'Position (mm)', va='center', fontsize=12)
